    ...
    <div key={headerGroup.id} className="flex w-full bg-[#ddebf7] ">
      {headerGroup.headers.map((header) => {
        ...
        return (
          ...
          >
            <p className="text-center font-bold cursor-pointer select-none overflow-hidden text-ellipsis whitespace-nowrap hover:scale-110 hover:transition-all hover:overflow-visible hover:bg-[#ddebf7] hover:">
